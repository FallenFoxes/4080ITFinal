...
public class NetworkedPlayers : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        if (IsServer) {
            ...
            NetworkManager.OnClientDisconnectCallback += ServerOnClientDisconneted;
        }
    ...
    {
        NetworkPlayerInfo client = new NetworkPlayerInfo(
            clientId);
        client.ready = false;
    ...
    private void ServerOnClientDisconneted(ulong clientId)
    {
